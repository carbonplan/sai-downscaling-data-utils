...
| [`notebook_helpers.py`](notebook_helpers.py) | Longer pieces of example code that used to live in the notebooks, e.g. example dates for each scenario and the quality flag summary. | The [subsetting-and-exporting](../notebooks/subsetting-and-exporting.ipynb) and [compute-resources](../notebooks/compute-resources.ipynb) notebooks |
